...
mysystem.segmenter = 'myim2segment2'; % What is the name of your segmentation-algorithm.
mysystem.features = 'mySegment2features2'; % What is the name of your features-algorithm.
