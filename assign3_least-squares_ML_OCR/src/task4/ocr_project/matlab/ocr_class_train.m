...
function classification_data = ocr_class_train(S,Y)
...
and corresponding letter code y. These are coded from 1 to 26, where 1 
corresponds to A, 2 corresponds to B and so forth. 
